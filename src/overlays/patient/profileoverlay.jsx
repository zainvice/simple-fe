    ...
    return (
        <div className='absolute flex-1 right-24 shadow-md p-6 top-8 bg-white rounded-[20px] text-lg'>
            ...
            <div className='text-lg text-[#888888]'>
                <p className='p-2  text-sm hover:bg-gray-200 hover:text-gray-500 duration-300 rounded-[10px] cursor-pointer' > <a href={`/${user?.role==='provider' ? 'provider': user?.role==='admin' ? 'admin' : 'patient'}/profile`} className='w-full h-full'>Profile</a></p>
