            ...
            {props?(
                <>
                   ...
                   <div className='flex'>
                       ...
                       <p className="font-semibold text-lg ml-2 text-[#00D97E] flex mt-2">{props?.name}{props?.active ? <span class="material-symbols-outlined text-[20px] ml-2 mt-1 text"> radio_button_checked </span>: <span class="material-symbols-outlined text-[20px] ml-2 mt-1 text-gray-400"> radio_button_unchecked </span>}</p>
                   </div>
                    ...
                    <div className="flex items-center p-4 bg-[#DCE8FF]">
                        <div className='flex p-3 bg-white rounded-[30px] justify-between w-[95%]'>
                            ...
                            <div className='flex font-thin space-x-2'>
                                <span className='material-symbols-outlined text-[#00D97E]'>attachment</span>
                                <span className='material-symbols-outlined text-[#00D97E]'>photo_camera</span>
                                <span className='material-symbols-outlined text-[#00D97E]'>sentiment_satisfied</span>
                                

                            </div>
                        </div>
                        <button className="p-3 mx-2 rounded-full bg-[#00D97E] text-white flex"><span class="material-symbols-outlined"> send </span></button>
